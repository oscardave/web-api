...
class BlockUsernameDao
{
    public static function list(array $request): array
    {
        $query = Db::table('ext_block_usernames')
            ->select('id', 'username', 'remark', 'status', 'created_at', 'updated_at')
    ...
    {
        $row = Db::table('ext_block_usernames')
            ->select('id', 'username', 'remark', 'status', 'created_at', 'updated_at')
            ->where('id', $request['id'])
            ->first();
    ...
    {
        $affectedRows = Db::table('ext_block_usernames')->insert([
    ...
    {
        $affectedRows = Db::table('ext_block_usernames')
            ->where('id', $request['id'])
            ->update([
                'username' => $request['username'],
                'remark' => $request['remark'],
