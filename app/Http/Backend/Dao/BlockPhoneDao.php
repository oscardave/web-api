...
class BlockPhoneDao
{
    ...
    {
        $query = Db::table('ext_block_phones')
            ->select('id', 'phone', 'remark', 'status', 'created_at', 'updated_at')
    ...
    {
        $affectedRows = Db::table('ext_block_phones')->insert([
            'phone' => $request['phone'],
    ...
    {
        $affectedRows = Db::table('ext_block_phones')
            ->where('id', $request['id'])
            ->update([
                'phone' => $request['phone'],
                'remark' => $request['remark'],
