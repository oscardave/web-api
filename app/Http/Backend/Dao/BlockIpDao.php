...
class BlockIpDao
{
    ...
    {
        $query = Db::table('ext_block_ips')
            ->select('id', 'ip', 'remark', 'status', 'created_at', 'updated_at')
    ...
    {
        $affectedRows = Db::table('ext_block_ips')->insert([
            'ip' => $request['ip'],
    ...
    {
        $affectedRows = Db::table('ext_block_ips')
            ->where('id', $request['id'])
            ->update([
                'ip' => $request['ip'],
                'remark' => $request['remark'],
